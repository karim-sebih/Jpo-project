...
<div className="description">
  ...
  <div className="social-links">
    <a href="https://www.facebook.com/LaPlateforme" target="_blank" rel="noopener noreferrer">Facebook</a>
    <a href="https://www.instagram.com/laplateforme/" target="_blank" rel="noopener noreferrer">Instagram</a>
    <a href="https://twitter.com/laplateforme" target="_blank" rel="noopener noreferrer">Twitter</a>
</div>
        <EventList />
      </main>
      <Footer />
