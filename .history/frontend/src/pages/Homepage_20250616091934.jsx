...
<div className="description">
  ...
  <p>Découvrer nos formations, rencontrez notre équipe, échangez avec les étudiants et explorez les locaux de La Plate Forme dans un codre immersif 100% tech.</p>
</div>
        <EventList />
      </main>
      <Footer />
